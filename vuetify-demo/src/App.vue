...
const notification = [
  ...
  { title: "Message from D", icon: "mdi-email", color: "purple" },
  { title: "Message from F", icon: "mdi-email", color: "orange" },
];
...
function changeTheme() {
  ...
  them.global.name.value = darkTheme.value ? "dark" : "light";
}
</script>
...
<template>
  <v-app>
    <v-toolbar density="compact">
      ...
      <v-toolbar-title>
        <RouterLink to="/">Jibu-Vuetify</RouterLink>
      </v-toolbar-title>
      ...
      <v-btn to="/login" variant="outlined" size="x-small" text="login">
        Login
      </v-btn>
    </v-toolbar>
